...
function playerSelRock() {
  ...
  // computerPrevious.push(computerChoice);
  // if (computerPrevious.length === 2) {
  //   console.log('before', computerTwoHandsAgo);
  //   var computerTwoHandsAgo = computerPrevious.shift();
  //   console.log('after', computerTwoHandsAgo);
  triggerGame();
}
